# Cortex + WeChat Deployment Guide
...
Use [docs/release-smoke.md](docs/release-smoke.md) before a release. It covers:

- `docker compose config` with the sibling `../cortex-wechat` repo
- Cortex health and authenticated ingest
- `bun run start:ilink` foreground startup
